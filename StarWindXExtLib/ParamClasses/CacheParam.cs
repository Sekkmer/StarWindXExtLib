namespace StarWindXExtLib
{
    ...
    {
        [Param()] public CacheMode CacheMode { get; set; }

        [Param(false, "CacheSize")]
        [IntZero("")]
        public int SizeInMB { get; set; }

        [Param(false)] [IntZero("")] public int CacheBlockExpiryPeriodMS { get; set; }

        [EnableParam("CacheSize")] public bool CacheEnabled => CacheMode != CacheMode.None || EnableNoneSize;

        public bool EnableNoneSize { get; set; } = false;

        [EnableParam("CacheBlockExpiryPeriodMS")]
        public bool EnableBlockExpiry { get; set; }
